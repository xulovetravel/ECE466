...
%token bucket output
[arrival_time, packetsize_p2, back_log, num_of_tokens] = textread('bucket_ethernet31.txt', '%f %f %f %f');
time2 = zeros(1,60000);
...
%sink output
[packet_no_p3, packetsize_p3, arrival_time] = textread('TrafficSinkOutputEther.txt', '%f %f %f');
time3 = zeros(1,60000);
