...
[arrival_time, packetsize_p2, back_log, num_of_tokens] = textread('bucket_poisson31.txt', '%f %f %f %f');
time2 = zeros(1,80000);
...
%Output for the sink.
[packet_no_p3, packetsize_p3, arrival_time] = textread('TrafficSinkOutputPoisson.txt', '%f %f %f');
time3 = zeros(1,80000);
