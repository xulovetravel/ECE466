...
%trace file
[packet_no_p, time_p, packetsize_p] = textread('ex3_GeneratorOutput.txt', '%f %f %f');
...
%token bucket output
[arrival_time, packetsize_p2, back_log, num_of_tokens] = textread('ex3_bucket.txt', '%f %f %f %f');
time2 = zeros(1,50000);
...
%sink output
[packet_no_p3, packetsize_p3, arrival_time2] = textread('ex3_TrafficSinkOutput.txt', '%f %f %f');
time3 = zeros(1,50000);
...
title('Token Bucket for experiment 3');
